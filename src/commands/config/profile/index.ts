...
function createProfileListCommand(): Command {
  ...
  command.description('List all configuration profiles').action(
    runAction(async () => {
...
function createProfileCreateCommand(): Command {
  ...
  command
    ...
    .action(
      runAction(async (rawName: string, options: unknown) => {
...
function createProfileUseCommand(): Command {
  ...
  command
    ...
    .argument('<name>', 'profile name')
    .action(
      runAction(async (rawName: string) => {
        const name = validateArgument(profileNameSchema, rawName, 'profile name');
        ...
        emitJson(
          ...
          },
          {
            text: () => {
              ...
              prefPairs.push([
                'aliases.n',
                profileConfig.preferences.aliases.n ? 'enabled' : 'disabled',
              ]);
...
function createProfileImportCommand(): Command {
  ...
  command
    ...
    .action(
      runAction(async (filePath: string, options: unknown) => {
