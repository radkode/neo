...
- [#28](https://github.com/radkode/neo/pull/28) [`363ae65`](https://github.com/radkode/neo/commit/363ae65b0e438bd5807230ab8c6033f24021369f) Thanks [@jacekradko](https://github.com/jacekradko)! - `neo init` now installs the bundled Claude Code skill at `~/.claude/skills/neo/SKILL.md`. No-op when `~/.claude` is absent; pass `--no-skill` to opt out, or `--force` to overwrite a divergent local copy.
...
- [#15](https://github.com/radkode/neo/pull/15) [`ddda768`](https://github.com/radkode/neo/commit/ddda768779414ade368e28bcc24791f39836a623) Thanks [@jacekradko](https://github.com/jacekradko)! - Add workflow commands: `neo sync`, `neo verify`, and `neo changeset`. `sync` rebases the current branch onto origin/<default> with auto-stash. `verify` runs build/test/lint/typecheck and reports structured pass/fail per script. `changeset` creates changeset files with an interactive prompt or fully non-interactively for agents.

## 1.3.0

### Minor Changes

- [#13](https://github.com/radkode/neo/pull/13) [`ff4185c`](https://github.com/radkode/neo/commit/ff4185c11809fece99d69a6a8fefa7286f1d58f3) Thanks [@jacekradko](https://github.com/jacekradko)! - Finish the agent-mode migration started in 1.2.0 and refresh the AI path.
...
- [#11](https://github.com/radkode/neo/pull/11) [`d043e00`](https://github.com/radkode/neo/commit/d043e00c8cb0c56f59e431a18295ed60909778da) Thanks [@jacekradko](https://github.com/jacekradko)! - feat: make the CLI agent-compatible end-to-end
